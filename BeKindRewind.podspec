...
Pod::Spec.new do |s|
  s.name             = 'BeKindRewind'
  s.version          = '3.0.0'
  s.summary          = 'A simple, native Swift way to record and replay network requests for testing and debugging.'
...
during testing and development.
  ...
  s.source_files = 'BeKindRewind/Classes/**/*'

  s.dependency 'OHHTTPStubs', '~> 6.0.0'
  s.framework = 'XCTest'

  # s.resource_bundles = {
  #   'BeKindRewind' => ['BeKindRewind/Assets/*.png']
  # }
