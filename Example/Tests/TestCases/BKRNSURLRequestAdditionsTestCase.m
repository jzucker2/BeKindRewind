...
- (void)testCompareRequestsWithDifferentQueryItemsOrder {
    NSURLRequest *request = [NSURLRequest requestWithURL:[NSURL URLWithString:@"http://google.com/foo=bar&baz=qux"]];
    NSURLRequest *otherRequest = [NSURLRequest requestWithURL:[NSURL URLWithString:@"http://google.com/baz=qux&foo=bar"]];
    XCTAssertNotNil(request);
    XCTAssertNotNil(otherRequest);
    XCTAssertFalse([request BKR_isEquivalentToRequest:otherRequest options:nil]);
...
- (void)testCompareRequestsAndIgnoreQueryItemsWithSpecificNames {
    NSURLRequest *request = [NSURLRequest requestWithURL:[NSURL URLWithString:@"http://google.com/foo=bar&baz=qux"]];
    NSURLRequest *otherRequest = [NSURLRequest requestWithURL:[NSURL URLWithString:@"http://google.com/foo=what&baz=qux"]];
    XCTAssertNotNil(request);
    XCTAssertNotNil(otherRequest);
    XCTAssertFalse([request BKR_isEquivalentToRequest:otherRequest options:nil]);
    NSDictionary *options = @{
...
- (void)testCompareRequestsAndIgnoreQueryItemsWithSpecificNamesAndIgnoreQueryItemsOrder {
    NSURLRequest *request = [NSURLRequest requestWithURL:[NSURL URLWithString:@"http://google.com/foo=bar&baz=qux&third=three"]];
    NSURLRequest *otherRequest = [NSURLRequest requestWithURL:[NSURL URLWithString:@"http://google.com/baz=qux&third=three&foo=what"]];
    XCTAssertNotNil(request);
    XCTAssertNotNil(otherRequest);
    XCTAssertFalse([request BKR_isEquivalentToRequest:otherRequest options:nil]);
    NSDictionary *options = @{
...
- (void)testCompareRequestsAndIgnoreSpecificComponentsProperties {
    ...
    NSURLRequest *otherRequest = [NSURLRequest requestWithURL:[NSURL URLWithString:@"http://googles.com/foo/bar"]];
    XCTAssertNotNil(request);
    XCTAssertNotNil(otherRequest);
    XCTAssertFalse([request BKR_isEquivalentToRequest:otherRequest options:nil]);
    NSDictionary *options = @{
                              kBKRIgnoreNSURLComponentsProperties: @[@"host"],
                              };
    XCTAssertTrue([request BKR_isEquivalentToRequest:otherRequest options:options]);
}
...
- (void)testCompareRequestsAndIgnoreSpecificComponentsPropertiesAndIgnoreQueryItemsWithSpecificNamesAndIgnoreQueryItemsOrder {
    NSURLRequest *request = [NSURLRequest requestWithURL:[NSURL URLWithString:@"http://googles.com/foo=bar&baz=qux&third=three"]];
    NSURLRequest *otherRequest = [NSURLRequest requestWithURL:[NSURL URLWithString:@"http://google.com/baz=qux&third=three&foo=what"]];
    XCTAssertNotNil(request);
    XCTAssertNotNil(otherRequest);
    XCTAssertFalse([request BKR_isEquivalentToRequest:otherRequest options:nil]);
